...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and slimcoin: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Slimcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Slimcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a slimcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Slimcoin command-line options").arg(PACKAGE_NAME));

    openChatroomAction = new QAction(tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open the Slimcoin Discord in a web browser."));

    openForumAction = new QAction(tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.slimcoin.net in a web browser."));
...
void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.slimcoin.net"));
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Slimcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
