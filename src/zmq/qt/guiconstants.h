...
#define QAPP_ORG_NAME "Slimcoin"
#define QAPP_ORG_DOMAIN "slimcoin.net"
#define QAPP_APP_NAME_DEFAULT "Slimcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Slimcoin-Qt-testnet"
#define QAPP_APP_NAME_REGTEST "Slimcoin-Qt-regtest"
