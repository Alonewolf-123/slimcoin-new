...
//    return n ? n : nTimeReceived;
    // slimcoin: we still have the timestamp, so use it to avoid confusion
    return tx->nTime;
}
...
//                }
                ...
                if (nFeeRet >= nFeeNeeded) {
                    ...
                    if (nChangePosInOut == -1 && nSubtractFeeFromAmount == 0 && pick_new_inputs) {
                        ...
                        CAmount minimum_value_for_change = MIN_TXOUT_AMOUNT;  //slmTODO - is this correct?
