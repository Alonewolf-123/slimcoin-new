...
const char * const BITCOIN_CONF_FILENAME = "slimcoin.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Slimcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Slimcoin
    // Mac: ~/Library/Application Support/Slimcoin
    // Unix: ~/.slimcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Slimcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Slimcoin";
#else
    // Unix
