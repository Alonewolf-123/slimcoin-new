...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " slimcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  slimcoin-tx [options] <hex-tx> [commands]  Update hex-encoded slimcoin transaction\n" +
            "or:     slimcoin-tx [options] -create [commands]   Create hex-encoded slimcoin transaction\n" +
            "\n";
