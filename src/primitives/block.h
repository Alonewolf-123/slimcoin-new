...
public:
    ...
    // slimcoin: A copy from CBlockIndex.nFlags from other clients. We need this information because we are using headers-first syncronization.
    int32_t nFlags;
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        // slimcoin: do not serialize nFlags when computing hash
