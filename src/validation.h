...
static const bool DEFAULT_TXINDEX = true;  // slimcoin: txindex is required for PoS calculations (might change in the future)
...
bool GetCoinAge(const CTransaction& tx, const CCoinsViewCache &view, uint64_t& nCoinAge, bool isTrueCoinAge = true); // slimcoin: get transaction coin age
