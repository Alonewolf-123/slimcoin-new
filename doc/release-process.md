...
### Build and sign Slimcoin for Linux, Windows, and macOS:
...
- Update other repositories and websites for new version
  ...
  - Update title of #slimcoin on Freenode IRC

  - Update packaging repo

  - Optionally twitter, reddit /r/Slimcoin, ... but this will usually sort out itself
  ...
  - Create a [new GitHub release](https://github.com/slimcoin/slimcoin/releases/new) with a link to the archived release notes.
